...
const ProfileCreation = () => {
    ...
    const createProfile = async (experience, interests, availability) => {
        const availMap = {}
        ...
        firebase.db.collection("profiles").doc(user + courseID).set({
            course: courseID,
    ...
    return (
        <div className="group-creation-form">
            ...
            <br></br>
            <input type="text" id="experience" name="experience" onChange={e => setExperience(e.target.value)}/>
            <br></br>
            <br></br>
            <label htmlFor="interests">Interests:</label>
            <br></br>
            <input type="text" id="interests" name="interests" onChange={e => setInterests(e.target.value)}/>
            <br></br>
            <br></br>
            ...
            <br></br>
            <br></br>
            <button onClick={() => {createProfile(experience, interests, availability)}} className="App-CreateButton">Create Profile</button>
        </div>
    )
}
