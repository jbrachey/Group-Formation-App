...
const ProfileUpdate = () => {
    ...
    const updateProfile = async (experience, interests, availability) => {
        const availMap = {}
    ...
    return (
        <div className="group-creation-form">
            ...
            <br></br>
            <input value={experience}type="text" id="experience" name="experience" onChange={e => setExperience(e.target.value)}/>
            <br></br>
            <br></br>
            <label htmlFor="interests">Interests:</label>
            <br></br>
            <input value={interests} type="text" id="interests" name="interests" onChange={e => setInterests(e.target.value)}/>
            <br></br>
            <br></br>
            ...
            <br></br>
            <br></br>
            { (experienceChanged || interestsChanged || availabilityChanged) &&
            <button onClick={() => {updateProfile(experience, interests, availability)}} className="App-CreateButton">Update Profile</button>
            }
            <BottomNav />
        </div>
    )
